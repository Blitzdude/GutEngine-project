...
void
ParticleBatch2D::update(float deltaTime) 
{
...
void 
ParticleBatch2D::draw(SpriteBatch* spriteBatch) 
{
...
void 
ParticleBatch2D::addParticle(const glm::vec2& position,
