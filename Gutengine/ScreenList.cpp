...
IGameScreen* 
Gutengine::ScreenList::movePrevious() 
{
    IGameScreen* currentScreen = getCurrent();
...
void
Gutengine::ScreenList::setScreen(int nextScreen)
{
    m_currentScreenIndex = nextScreen;
}

void 
Gutengine::ScreenList::addScreen(IGameScreen* newScreen)
{
