...
SoundEffect 
AudioEngine::loadSoundEffect(const std::string& filePath) 
{
...
Music
AudioEngine::loadMusic(const std::string& filePath) 
{
	// Try to find the audio in the cache
