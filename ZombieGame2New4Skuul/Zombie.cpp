...
void Zombie::init(float speed, glm::vec2 pos) {
    ...
    _health = 50;
    // Set Green Color
    _color = Gutengine::ColorRGBA8(255, 255, 255, 255);
    m_textureID = Gutengine::ResourceManager::getTexture("Textures/zombie.png").id;
}

void Zombie::init(float speed, glm::vec2 pos, float size) {
	_speed = speed;
	_position = pos;
	m_size = size;
	_health = 50;
