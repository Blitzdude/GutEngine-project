...
void Bullet::draw(Gutengine::SpriteBatch& spriteBatch) {
    ...
    spriteBatch.draw(destRect, uvRect, Gutengine::ResourceManager::getTexture("Textures/circle.png").id, 0.0f, color);
}
